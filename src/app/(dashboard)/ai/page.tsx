...
import { Sparkles, Clock, Users, ChefHat, Package, Leaf, Flame, Wheat, Drumstick, FlameKindling } from "lucide-react"
...
const DIETS = [
  { id: "",          label: "No Filter",   icon: ChefHat,       color: "bg-[#E8DCC8] text-[#2C1810] border-[#D4A853]" },
...
export default function AIPage() {
  ...
  async function getSuggestions() {
    ...
    try {
      ...
      toast.error("AI Chef is unavailable right now")
    } finally {
      setLoading(false)
    }
  }
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            {loading
              ...
              : diet
                ? "Suggest " + activeDiet.label + " Recipes"
                : "Ask the AI Chef"}
          </Button>
        </div>
      </div>
